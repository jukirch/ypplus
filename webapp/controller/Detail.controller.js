sap.ui.define([
	...
	return Controller.extend("ypplus.controller.Detail", {
		onInit: function () {
		...
		handleItemPress: function (oEvent) {
			var oNextUIState = this.getOwnerComponent().getHelper().getNextUIState(2),
				supplierPath = oEvent.getSource().getSelectedItem().getBindingContext("northWind").getPath(),
		...
		handleClose: function () {
			...
			this.oRouter.navTo("Main2", {layout: sNextLayout});
		},
