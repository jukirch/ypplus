			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypshopping-display": {
								"semanticObject": "ypshopping",
								"action": "display",
								"description": "A Young Professional Shopping App.",
								"title": "Shopping App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypshopping",
									"url": sap.ui.require.toUrl("ypshopping")
								}
							}
						}
					}
